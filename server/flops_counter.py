...
def get_model_complexity_info(model, input_res, print_per_layer_stat=True, as_strings=True):
    ...
    #raise ValueError("Stopping at GET MODEL COMPLEXITY flops_counter19")
    if print_per_layer_stat:
        print_model_with_flops(flops_model)
    flops_count = flops_model.compute_average_flops_cost()#37176320.0 
    params_count = get_model_parameters_number(flops_model) #11176512
